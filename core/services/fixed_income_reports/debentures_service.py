...
class DebenturesService:
    """Classe para requisitar relatório RF de Debentures."""

    def __init__(self) -> None:
        self.config_service = ConfigService()

    def get_debentures_report(self):
        """Requisita relatório RF de Debentures."""
        endpoint = "/api-partner-report-extractor/api/v1/report/debentures"
