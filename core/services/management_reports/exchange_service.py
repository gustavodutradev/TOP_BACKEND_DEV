...
class ExchangeService:
    """Classe para requisitar relatório gerencial de Câmbio dos últimos 5 dias."""

    def __init__(self) -> None:
        self.config_service = ConfigService()

    def get_exchange_report(self):
        """Requisita relatório gerencial Base BTG"""
        endpoint = "/api-rm-reports/api/v1/rm-reports/exchange-operation"
