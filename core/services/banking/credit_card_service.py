...
class CreditCardService:
    """Classe para requisitar relatório gerencial de Cartão de Crédito."""

    def __init__(self) -> None:
        self.config_service = ConfigService()

    def get_credit_card_report(self):
        """Requisita relatório gerencial de Cartão de Crédito"""
        endpoint = "/api-rm-reports/api/v1/rm-reports/credit-card"
