...
class BankingService:
    """Classe para requisitar relatório gerencial de Banking."""

    def __init__(self) -> None:
        self.config_service = ConfigService()

    def get_banking_report(self):
        """Requisita relatório gerencial de Banking"""
        endpoint = "/api-rm-reports/api/v1/rm-reports/banking"
