...
from core.services.management_reports.nnm_service import NNMReportService
...
class NNMController:
    def __init__(self, app):
        self.nnm_service = NNMReportService()
    ...
    def register_routes(self) -> None:
        ...
        self.app.add_url_rule(
            "/api/v1/rg-nnm", "rg_nnm_handler", self.handler, methods=["POST"]
        )
    ...
    def _handle_initial_request(self) -> Tuple[Dict[str, Any], int]:
        ...
        if not self.nnm_service.get_nnm_report():
            return {
                "error": "Falha ao iniciar a requisição de relatório gerencial NNM."
    ...
    def _process_webhook(self, data: Dict[str, Any]) -> Tuple[Dict[str, Any], int]:
        ...
        self.logger.logger.info("Relatório de NNM gerado com sucesso.")
