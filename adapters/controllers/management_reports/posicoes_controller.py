...
class PositionReportController:
    ...
    def register_routes(self):
        @self.app.route(
            "/api/v1/rg-posicoes", methods=["POST"], endpoint="rg_posicoes_handler"
        )
        def handler():
            ...
            try:
                ...
                response = self.position_report_service.get_positions_report()
    ...
    def _process_webhook(self, data):
        ...
        try:
            ...
            self.logger.logger.info(f"Relatório de Posições gerado com sucesso.")
